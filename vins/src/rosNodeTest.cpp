...
int main(int argc, char **argv)
{
    ...
    // rclcpp::Logger::Level level = rclcpp::Logger::Level::DEBUG;
    // rclcpp::LoggingSeverity severity = static_cast<rclcpp::LoggingSeverity>(level);
    // rcutils_logging_set_logger_level(logger.get_name(), severity);
    ...
    auto sub_img0 = n->create_subscription<sensor_msgs::msg::Image>(IMAGE0_TOPIC, rclcpp::QoS(rclcpp::KeepLast(1000)), img0_callback);
